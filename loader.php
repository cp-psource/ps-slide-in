...
$MyUpdateChecker = Puc_v4_Factory::buildUpdateChecker(
	'https://n3rds.work//wp-update-server/?action=get_metadata&slug=ps-slide-in', //Metadata URL.
	__FILE__, //Full path to the main plugin file.
	'ps-slide-in' //Plugin slug. Usually it's the same as the name of the directory.
);
